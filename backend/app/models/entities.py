...
class AccountDailyStat(UUIDMixin, TimestampMixin, Base):
    ...
    latest_balance: Mapped[Decimal | None] = mapped_column(money)
    latest_equity: Mapped[Decimal | None] = mapped_column(money)
    margin: Mapped[Decimal | None] = mapped_column(money)
    margin_level: Mapped[Decimal | None] = mapped_column(Numeric(18, 4))
    daily_loss: Mapped[Decimal | None] = mapped_column(money)
